...
class StockConsumer(AsyncWebsocketConsumer):
    ...
    def addToCeleryBeat(self,stockpicker):
        ...
        if len(task)>0:
            ...
            task = PeriodicTask.objects.create(interval = schedule, name='every-10-seconds', task="mainapp.tasks.stockUpdate", args = json.dumps([stockpicker]))
    async def connect(self):
        ...
        stockpicker = query_param['stockpicker']
    ...
    #function name will be same as type in tasks.py that calls this function
